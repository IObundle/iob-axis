            ...
            {"name": "iob_s_port", "descr": "CPU native interface", "ports": []},
            {
                ...
                "ports": [
                    ...
                    },
                    {
                        ...
                        "type": "O",
                        "n_bits": "1",
                        "descr": "Interrupt pin: goes high if the FIFO goes above the threshhold level; remains low otherwise.",
                    },
                ],
            },
            {
        ...
        cls.regs += [
            {
                ...
                "regs": [
                    ...
                    },
                    {
                        ...
                        "log2n_items": 0,
                        "autologic": True,
                        "descr": "Interrupt lower level threshold: an interrupt is triggered when the FIFO's level is above this threshold.",
                    },
                ],
            }
        ]
